...
func TestParser_ParseLogger(t *testing.T) {
	...
	testutils.AssertEquals(t, loggerTemplate.RequestTemplate, logger.RequestTemplate())
	testutils.AssertEquals(t, loggerTemplate.ResponseTemplate, logger.ResponseTemplate())
}
